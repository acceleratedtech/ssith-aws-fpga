...
public:
    ...
    int io_awaddr ( const uint64_t awaddr, const uint16_t awlen, const uint16_t awid ) { return cb->io_awaddr (&pint, awaddr, awlen, awid); };
    int io_araddr ( const uint64_t araddr, const uint16_t arlen, const uint16_t arid ) { return cb->io_araddr (&pint, araddr, arlen, arid); };
...
public:
    ...
    virtual void io_awaddr ( const uint64_t awaddr, const uint16_t awlen, const uint16_t awid ) = 0;
    virtual void io_araddr ( const uint64_t araddr, const uint16_t arlen, const uint16_t arid ) = 0;
